                                ...
                                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                    ...
                                    <table class="min-w-full divide-y divide-gray-300">
                                        <thead>
                                            <tr>
                                                <th scope="col"
                                                    class="whitespace-nowrap py-3.5 pl-4 pr-3 w-1/4 text-sm font-semibold text-gray-900 sm:pl-0">
                                                    Customer Name
                                                </th>
                                                <th scope="col"
                                                    class="whitespace-nowrap py-3.5 pl-4 pr-3 w-1/4 text-sm font-semibold text-gray-900 sm:pl-0">
                                                ...
                                                <th scope="col"
                                                    class="whitespace-nowrap px-2 py-3.5 w-1/4 text-sm font-semibold text-gray-900">
                                                    Amount
                                                </th>
                                                <th scope="col"
                                                    class="whitespace-nowrap px-2 py-3.5 w-1/4 text-sm font-semibold text-gray-900">
